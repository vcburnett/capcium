...
<body>
	...
	<div id="wrapper">
		<!-- HERO -->
		<section class="inner-header" id="page-our-facility">
		...
		<section class="content" id="sec-first-content">
			<div class="content-wrapper">
				<div class="main-text-wrap">
					<p>Capcium has developed a two-phase commercial strategy to best serve our licensed cannabis producer partners as well as our nutraceutical and pharmaceutical customers.</p>
				</div>
