...
<body>
	...
	<section id="job-apply-lightbox">
		<div id="job-apply-form-wrap">
			...
			<form id="application-form">
				...
				<label>Upload your CV <span class="label-exp">(.doc or .pdf)</span></label>
				<input type="file" name="cv" accept=".doc,.pdf">
				<label>Upload your Cover Letter <span class="label-exp">(.doc or .pdf)</span></label>
				<input type="file" name="cover-letter" accept=".doc,.pdf">
				<input type="Submit">
				<a href="javascript:void(0);" class="application-close-btn">Cancel</a>
			</form>
		</div>
	</section>
		...
		<section class="content" id="sec-first-content">
			<div class="content-wrapper">
				<div class="main-text-wrap">
					<p>With the rapidly evolving nature of the cannabis industry, we are always on the look-out for talented people to help us achieve our goals.</p>
					<p>Join a dynamic team that is making waves in the cannabis industry. Check out our job postings below, or feel free to send us your resume at <a href="mailto:careers@capcium.com">careers@capcium.com</a>.</p>
				</div>
					...
					<div class="career-job-posting">
						...
						<div class="career-job-description">
							...
							<ul class="internal-content-list">
								<li>Ut non malesuada urna. Curabitur maximus sed magna ut molestie.</li>
								<li>Phasellus imperdiet volutpat massa, non iaculis nunc sagittis vel. Donec vitae suscipit purus, non posuere orci.</li>
								<li>In scelerisque porta libero eu aliquet. Donec viverra justo odio, vitae consequat mi egestas eget. Nulla vel facilisis justo. Donec ac venenatis nulla, a malesuada odio. Nulla vel arcu posuere, vehicula velit at, molestie dui.</li>
								<li>Maecenas quis ullamcorper ex, sed vestibulum libero. Praesent lobortis fringilla semper. Pellentesque vel nisl est.</li>
								<li>Nulla ornare risus vitae congue gravida. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Praesent blandit at odio quis convallis. Nullam id venenatis mi. Cras mollis quis orci eu ullamcorper.</li>
							</ul>
							<h4>The job is yours if:</h4>
							<ul class="internal-content-list">
								<li>Ut non malesuada urna. Curabitur maximus sed magna ut molestie.</li>
								<li>Phasellus imperdiet volutpat massa, non iaculis nunc sagittis vel. Donec vitae suscipit purus, non posuere orci.</li>
								<li>In scelerisque porta libero eu aliquet. Donec viverra justo odio, vitae consequat mi egestas eget. Nulla vel facilisis justo. Donec ac venenatis nulla, a malesuada odio. Nulla vel arcu posuere, vehicula velit at, molestie dui.</li>
